...
CRITICAL: The <information> tag is produced ONLY by the retrieval system after a <search>. NEVER write, paraphrase, or fabricate an <information> block yourself — if you need facts, emit <search> and stop. Any <information> you invent will be treated as hallucination. \
"""
