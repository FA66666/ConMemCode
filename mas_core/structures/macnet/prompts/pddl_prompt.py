...
4. If a <valid_action_constraint> block is present, it overrides drafts, critic feedback, and all other action-format guidance; copy exactly one listed action into <action>...</action>.
...
# --- actor prompt ---
ACTOR_SYSTEM_PROMPT_TEMPLATE = PDDL_SYSTEM_PROMPT
...
# --- summarizer prompt ---
SUMMARIZER_SYSTEM_PROMPT_TEMPLATE = PDDL_SYSTEM_PROMPT + " Choose the best next action after considering both drafts and critic feedback."
